...
export function CssFrameworks() {
	...
	const frameworks: CssExample[] = [
		{
			id: "tailwind",
			name: "Tailwind CSS",
			code: `<div class="levita w-64 h-80 rounded-xl bg-white shadow-lg p-6 flex flex-col justify-between">
  ...
  <button class="w-full py-2 bg-slate-900 text-white rounded-md text-sm font-medium">Action</button>
			...
			render: () => (
				<div class="w-64 h-80 rounded-xl bg-white shadow-lg p-6 flex flex-col justify-between border border-white/10">
					<div class="h-32 bg-indigo-500 rounded-lg" data-levita-offset="20"></div>
...
<div class="levita card">
  ...
  <h3 data-levita-offset="50">Vanilla CSS</h3>
		...
		},
		{
			id: "bootstrap",
			name: "Bootstrap",
			code: `<div class="levita card border-0 shadow-sm" style="width: 16rem;">
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary btn-sm">Explore</a>
			...
			render: () => (
				<div class="w-64 h-80 bg-white rounded-lg shadow-md p-0 flex flex-col overflow-hidden">
		...
		},
		{
			id: "semantic",
			name: "Semantic UI",
			code: `<div class="levita ui card">
  <div class="image">
    <div class="ui placeholder segment h-32" data-levita-offset="20"></div>
  </div>
  <div class="content">
    <a class="header" data-levita-offset="40">Semantic UI</a>
    <div class="meta"><span>Library</span></div>
  </div>
</div>`,
			render: () => (
				<div class="w-64 h-80 bg-white rounded border border-slate-200 shadow-sm overflow-hidden">
					...
					<div class="p-4">
						<h3 class="text-slate-900 font-bold text-lg" data-levita-offset="40">
							Semantic UI
						</h3>
		...
		},
		{
			id: "flowbite",
			name: "Flowbite",
			code: `<div class="levita max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Flowbite component style.</p>
			...
			render: () => (
				<div class="w-64 h-80 p-6 bg-slate-800 border border-slate-700 rounded-lg shadow-xl flex flex-col">
					<div
      ...
      <div class="content">
        <p data-levita-offset="20">
          ...
          Leveraging the modern flexbox-based framework.
			...
			render: () => (
				<div class="w-64 h-80 bg-white rounded-md shadow p-6 flex flex-col border border-slate-200">
			...
			<div class="flex flex-col gap-8">
				...
				<div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
					<div class="flex justify-center py-10 bg-surface/30 rounded-3xl border border-dashed border-border">
						<Tilt options={{ glare: true, shadow: true }} class="cursor-pointer">
